...
import 'package:sews_projet/components/container.dart';
                                ...
                                child: Form(
                                  ...
                                  child: Autocomplete<String>(
                                    ...
                                    optionsBuilder:
                                      ...
                                      return numSerie.where((String option) {
                                        return option
                        ...
                        children: [
                          MyContainer(
                            ...
                            widget1: MyTextButton(
                              onPressed: () async {
                                await Get.to(() => const ManualAdditionPage(),
                            ...
                            widget2: MyTextButton(
                                onPressed: () async {
                                  await Get.to(() => const AddExcelFilePage(),
                                      transition: Transition.cupertino);
                                  widget.updateCallback();
                                },
